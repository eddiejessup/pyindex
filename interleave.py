...
def part1by4(n):
    ...
    n = (n | n << 16) & 17293839061792849935L
    n = (n | n << 8) & 3545237007667534236675L
    n = (n | n << 4) & 38997607084342876603425L
    return int(n)
...
def unpart1by4(n):
    ...
    n: 32-bit integer
    """
    n &= 38997607084342876603425L
    n = (n | n >> 4) & 3545237007667534236675L
    n = (n | n >> 8) & 17293839061792849935L
